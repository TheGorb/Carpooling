  ...
  const renderForm = () => {
    return (
      <View style={styles.formBlock}>
        <View>
          <Text style={styles.textAndIconInBlack}>Departure</Text>
          <View style={styles.inputBlock}>
            <FontAwesome5
              name="route"
              style={styles.textInputIcons}></FontAwesome5>
            <TextInput
        ...
        <View>
          <Text style={styles.textAndIconInBlack}>Arrival</Text>
          <View style={styles.inputBlock}>
            <FontAwesome5
              name="route"
              style={styles.textInputIcons}></FontAwesome5>
        ...
        <View>
          <Text style={styles.textAndIconInBlack}>Date</Text>
          <View style={styles.inputBlock}>
            <FontAwesome5
              name="calendar-alt"
              style={styles.textInputIcons}></FontAwesome5>
        ...
        <View>
          <Text style={styles.textAndIconInBlack}>
    ...
    return (
      <View
        ...
        <TouchableOpacity
          ...
          <Text
            style={{
              color: !isDriver ? 'black' : isDriver == null ? 'black' : 'white',
            }}>
            I am the driver
          </Text>
        </TouchableOpacity>
